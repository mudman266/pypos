...
class Ui_payment_amount_dialog(object):
    def setupUi(self, payment_amount_dialog):
        ...
        self.label_2 = QtWidgets.QLabel(payment_amount_dialog)
        self.label_2.setGeometry(QtCore.QRect(150, 40, 171, 31))
    ...
    def retranslateUi(self, payment_amount_dialog):
        ...
        self.label_2.setText(_translate("payment_amount_dialog", "$0.00"))
