...
class Ui_employee_setup(object):
    def setupUi(self, employee_setup):
        ...
        self.job_class_combo_box = QtWidgets.QComboBox(self.formLayoutWidget)
        self.job_class_combo_box.setObjectName("job_class_combo_box")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.job_class_combo_box)
        self.btn_cancel = QtWidgets.QPushButton(employee_setup)
        self.btn_cancel.setGeometry(QtCore.QRect(620, 610, 100, 100))
        ...
        self.btn_ok.setGeometry(QtCore.QRect(440, 610, 100, 100))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(20)
        ...
        self.btn_new = QtWidgets.QPushButton(employee_setup)
        self.btn_new.setGeometry(QtCore.QRect(260, 610, 101, 101))
        font = QtGui.QFont()
        font.setFamily("Bookman Old Style")
        font.setPointSize(22)
    ...
    def retranslateUi(self, employee_setup):
        ...
        self.btn_new.setText(_translate("employee_setup", "New"))
