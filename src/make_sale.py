...
class Ui_SaleWindow(object):
    def setupUi(self, SaleWindow):
        ...
        self.btn_manager = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(20)
        ...
        self.horizontalLayout.addWidget(self.btn_manager)
    ...
    def retranslateUi(self, SaleWindow):
        ...
        self.btn_manager.setText(_translate("SaleWindow", "Manager"))
