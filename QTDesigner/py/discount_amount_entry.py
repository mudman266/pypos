...
class Ui_discount_amount_dialog(object):
    def setupUi(self, discount_amount_dialog):
        ...
        discount_amount_dialog.resize(549, 581)
        self.gridLayoutWidget = QtWidgets.QWidget(discount_amount_dialog)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(80, 130, 411, 401))
        ...
        self.lbl_discount_amount = QtWidgets.QLabel(discount_amount_dialog)
        self.lbl_discount_amount.setGeometry(QtCore.QRect(160, 70, 241, 41))
        font = QtGui.QFont()
        font.setFamily("Book Antiqua")
